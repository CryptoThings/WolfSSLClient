...
WOLFSSL_API int  wc_MakeCert(Cert*, byte* derBuffer, word32 derSz, RsaKey*,
    ...
    WOLFSSL_API int  wc_MakeCertReq(Cert*, byte* derBuffer, word32 derSz,
                                    RsaKey*, ecc_key*);
#endif
typedef int (*CallbackEccSignCert) (const byte* in, word32 inlen,
    byte* out, word32 *outlen, WC_RNG* rng, void *ctx);

WOLFSSL_API int  wc_SignCert_cb(int requestSz, int sigType, byte* derBuffer,
                         word32 derSz, RsaKey*, ecc_key*, WC_RNG*,
                         CallbackEccSignCert, void* cb_ctx);
WOLFSSL_API int  wc_SignCert(int requestSz, int sigType, byte* derBuffer,
                         word32 derSz, RsaKey*, ecc_key*, WC_RNG*);
WOLFSSL_API int  wc_MakeSelfCert(Cert*, byte* derBuffer, word32 derSz, RsaKey*,
                             WC_RNG*);
WOLFSSL_API int  wc_MakeSelfCertEcc(Cert*, byte* derBuffer, word32 derSz, ecc_key*,
                             WC_RNG*);
