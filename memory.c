...
//    #ifdef WOLFSSL_MALLOC_CHECK
//        if (res == NULL) {
//            Logging_cb(0, "wolfSSL_malloc failed");
//        }
//    #endif
                
//    snprintf(g_printf_buf, 32, "m %d %x", size, (unsigned long)res);
//    Logging_cb(7, g_printf_buf);
...
//    snprintf(g_printf_buf, 32, "f %x", (unsigned long)ptr);
//    Logging_cb(7, g_printf_buf);
}
...
//    snprintf(g_printf_buf, 32, "r %d %x -> %x", size, (unsigned long)ptr, (unsigned long)res);
//    Logging_cb(7, g_printf_buf);
